...
spawn_point=world.get_map().get_spam_points()[0]
vehicle=world.spam_actor(vehicle_bp,spawn_point)
...
def obstacle_detection(source): #source is the video which is going to be played
